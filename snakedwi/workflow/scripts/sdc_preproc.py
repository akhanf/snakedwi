...
workflow = Workflow(name='sdc_workflow')
...
syn_preprocessing_wf.inputs.inputnode.std2anat_xfm = Path(snakemake.input.std2anat_xfm).resolve()
syn_preprocessing_wf.inputs.inputnode.mask_anat = Path(snakemake.input.mask_anat).resolve()
